...
![1536227104531n](ComputerNetwork.assets/1536227104531[2].bmp "自顶向下削发为僧大纲")
...
![1565](ComputerNetwork.assets/1565.bmp)
...
- **广播链路**/**共享介质**（如总线以太网、HFC上行链路、802.11无线局域网等）
...
- 帧过滤/转发：若目的接口与接收接口**相同**，则**丢弃帧**；若未学习到目的接口，则向所有接口转发（**泛洪**）。

由于同一IP子网中广播帧将被交换机泛洪至所有主机，故IP子网又称为**广播域**。

![网络设备对比](ComputerNetwork.assets/网络设备对比.bmp)
